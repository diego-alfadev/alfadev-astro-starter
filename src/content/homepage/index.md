...
banner:
  ...
  button:
    label: View the repo
    link: "https://github.com/alfadev/alfadev-astro"
    enable: true
...
features:
  ...
  feature_list:
    ...
    - icon: "clock"  #icon package react-feather-icon [https://feathericons.com/]
      title: Up-to-date
      content: Using the latest version and best practices of <span class="text-accent font-bold">Astro</span>, <span class="text-[#38bdf8] font-bold">tailwind</span> and <span class="text-[#e41c81] font-bold">Sass</span>
...
call_to_action:
  ...
  button: 
    ...
    link: "https://github.com/diego-alfadev/alfadev-astro"
